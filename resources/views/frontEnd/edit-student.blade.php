                    ...
                    <form action="{{ url('/update-student') }}" method="post">
                        ...
                        <table>
                            <tr>
                                <td>Name</td>
                                <td>
                                    <input type="text" value="{{ $studentById->name }}" name="name">
                                    <input type="hidden" value="{{ $studentById->id }}" name="a">
                                </td>
                            </tr>
                            <tr>
                                <td>Email</td>
                                <td><input type="email" value="{{ $studentById->email }}" name="email"></td>
                            </tr>
                            <tr>
                                <td>Mobile</td>
                                <td><input type="number" value="{{ $studentById->mobile }}" name="mobile"></td>
                            </tr>
                            <tr>
                                <td></td>
